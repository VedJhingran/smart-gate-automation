...
| PWA dashboard | Wiring | Architecture |
| --- | --- | --- |
| _Add `docs/images/pwa-dashboard.png`_ | _Add `docs/images/wiring-diagram.png`_ | _Add `docs/images/architecture.png`_ |

Do not upload screenshots that reveal home addresses, camera feeds, device tokens, Wi-Fi names, or private IP addresses.
