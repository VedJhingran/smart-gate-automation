...
| --- | --- |
| ![Smart Gate Automation PWA dashboard](docs/images/pwa-dashboard.png) | ![ESP32 Smart Gate Automation wiring diagram](docs/images/hardware-wiring.png) | 
| ![Smart Gate Automation PWA dashboard](docs/images/PWA-app-2.png) |
